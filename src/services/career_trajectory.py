...
TRANSITION_SKILLS: Dict[str, List[str]] = {
    "software_engineering→engineering_management": [
        "People management", "Agile/Scrum", "Hiring & interviewing",
        "Project planning", "Stakeholder communication", "OKR setting",
    ],
    "software_engineering→data_science": [
        "Statistics", "Python (ML libs)", "SQL analytics",
        "A/B testing", "Model evaluation", "Data visualization",
    ],
    "data_science→product_management": [
        "User research", "Roadmap planning", "Stakeholder management",
        "Metrics/KPI definition", "Prioritization frameworks",
    ],
    "software_engineering→devops_sre": [
        "CI/CD", "Infrastructure as Code", "Monitoring & observability",
        "Linux systems", "Container orchestration", "Incident management",
    ],
}
...
class CareerTrajectoryEngine:
    ...
    def suggest_paths(
        self, current_title: str, years_experience: float = 0
    ) -> List[Dict[str, Any]]:
    ...
    def estimate_timeline(
        self, current_title: str, target_title: str
    ) -> Dict[str, Any]:
        """
