...
class JobApplication:
	...
	def to_notion_properties(self) -> Dict:
		...
		return {
			'Company': {'title': [{'text': {'content': self.company}}]},
			'Role': {'rich_text': [{'text': {'content': self.role}}]},
			'Status': {'select': {'name': self.status}},
			'Applied Date': {'date': {'start': self.applied_date}},
			'URL': {'url': self.url if self.url else None},
			'Salary Range': {'rich_text': [{'text': {'content': self.salary_range}}]},
			'Notes': {'rich_text': [{'text': {'content': self.notes}}]},
			'Next Step': {'rich_text': [{'text': {'content': self.next_step}}]},
...
def add_job_application(
	company: str, role: str, url: str = '', salary_range: str = '', notes: str = '', priority: str = 'Medium'
) -> Dict:
	"""
...
def update_application_status(
	company: str, role: str = '', new_status: str = 'In Progress', next_step: str = '', notes: str = ''
) -> Dict:
	"""
	...
	if updated:
		...
		return {'success': True, 'message': f'Updated {company} status to {new_status}', 'application': app}
	else:
		console.warning(f'Application not found for {company}')
		return {'success': False, 'message': f'No application found for {company}'}


def get_applications_by_status(status: str = '') -> Dict:
	"""
...
class JobTrackerAgent(BaseAgent):
	...
	async def add_application(
		self, company: str, role: str, url: str = '', salary_range: str = '', notes: str = '', priority: str = 'Medium'
	) -> Dict:
